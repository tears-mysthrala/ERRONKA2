...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($name === '') {
        ...
        $stmt = $pdo->prepare("INSERT INTO employees(name, email, phone, role) VALUES(?,?,?,?)");
...
<form method="post" class="row g-3 col-md-6">
  ...
  <div class="col-12">
    ...
    <input type="text" name="role" class="form-control" placeholder="Farmacéutico, Técnico, Administración...">
  </div>
  <div class="col-12">
