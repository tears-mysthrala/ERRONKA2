...
<form class="row g-2 mb-3" method="get">
  <div class="col-md-4">
    <input type="text" name="q" value="<?=htmlspecialchars($q)?>" class="form-control" placeholder="Izena edo SKUaren arabera bilatu">
  </div>
  <div class="col-md-2">
    <button class="btn btn-outline-primary">Bilatu</button>
  </div>
  <div class="col-md-3">
    <a href="new.php" class="btn btn-primary">Produktua berria</a>
  </div>
</form>
<table class="table table-striped table-hover">
  <thead>
    <tr>
      <th>Izena</th><th>SKU</th><th>Prezioa</th><th>Deskribapena</th><th class="text-end">Ekintzak</th>
    </tr>
  </thead>
  <tbody>
  <?php foreach ($rows as $r): ?>
    <tr>
      ...
      <td class="text-end table-actions">
        ...
        <a class="btn btn-sm btn-danger" href="delete.php?id=<?=$r['id']?>" onclick="return confirm('Ziur zaude produktu hau ezabatu nahi duzula?');">Ezabatu</a>
      </td>
    </tr>
  <?php endforeach; ?>
  </tbody>
